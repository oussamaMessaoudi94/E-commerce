...
export class ShopSingleUserComponent implements OnInit {
  ...
  title!: String
  users :any
  constructor(private activatedRouter: ActivatedRoute, private productService: ProductService, private fb :FormBuilder, private router: Router, private shopSingle: ShopSingleService) { }
